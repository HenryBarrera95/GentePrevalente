...
export const Navbar = () => {
    ...
    return (      
        ...
        <nav className='h-16 flex items-center flex-wrap  bg-navbar-gray'>
          <Link href='/'>
            <a className='inline-flex items-center'>
              <img className='lg:ml-10 transform scale-40' src="/items/BrainLogo.png"></img>
        ...
        <input className="bg-navbar-gray" type="text" placeholder='Buscar...'></input>
        </div>
        ...
        >
          <div className='lg:inline-flex lg:flex-row lg:ml-auto lg:w-auto  w-full lg:items-center items-start  flex flex-col '>
            ...
            <Link href='/'>
              ...
              <span className="ml-0 lg:inline-flex items-center justify-center px-1 py-0 text-xs text-red-100 transform -translate-y-1/2 bg-red-600 rounded-full">2</span>
              </a>
            </Link>
            <Link href='/'>
              ...
              <span className='text-white text-brain'>
              Empleo
              </span>
